...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
       ...
       <?php
            ...
            $len=count($data);
               for($n=1;$n<=$len-1;$n++){  
                   ...
                   $mrp=ltrim($mrp, $mrp[0]);
                   $price="₹".$price;
                   $bgsiz=json_encode( $trial[6] );
                   $stin=json_encode( $trial[7] );
                    $bgsiz=str_replace('"','',$bgsiz);
                   $stin=str_replace('"','',$stin);
                   $stin=str_replace(']','',$stin);
                   $img=json_encode( $trial[4] );
                   $img=str_replace('\\','',$img);
                   $img=str_replace('"','',$img);
                ?>
    ...
    x.innerHTML = chck+"<button class='infbtn' id='"+i12+"' onclick='tejhorheho(this.id)'><i>i</i></button>"+"<br>"+"PER KG"+"<br>"+chck1+"&nbsp&nbsp&nbsp"+"<s>"+chck2+"</s>";
...
document.getElementById("qt"+in1).innerHTML=ch1;}
    ...
    x.appendChild(btn);
           ...
           function tejhorheho(i1){
               ...
               alert("Name : "+cellVal+"\n"+"Brand : "+yopu+"\n"+"Bag Packing : "+yopu1+"\n"+"Inner Bag Packing : "+y1opu+"\n"+"* Avaiable In "+yopu1+" With "+y1opu+" Bag Packing Inside *");
               }
               else{
                   alert("Name : "+cellVal+"\n"+"Brand : "+yopu+"\n"+"Bag Packing : "+yopu1);
               }
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    if (td) {
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
       ...
       <div id="cm">YOUR ORDER<br>HAS BEEN<br>PLACED<br>WE WILL CONTACT YOU SHORTLY</div>
    </body>
