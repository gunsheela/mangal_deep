...
a{
    ...
    <button class="btn" onclick="rel()" style="display:none" id="bn">Back</button>    <button id=cn style="display:none">Cancel Order</button>
<div id="st"></div>      <div class="loader" id="lo"></div><table id="mt" cellspacing=6px></table>
                      ...
                      if(o_l[cnt]!=""){
                          ...
                          btn.onclick=function(){
                              ...
                              firebaseRef2.once("value",function(snapshot){
                                  ...
                                  var str1="PENDING";
                                  var z=str1.localeCompare(pawa[1]);
                                  if(z!=0)
                                      {
                                  ...
                                  else{                                                            document.getElementById("cn").style.display="block";

                                                                        document.getElementById("cn").enabled= "true";
                                                                      document.getElementById("cn").style.cursor= "pointer";
                                       document.getElementById("cn").onclick=function()
                                       {
                                           var data;
                                           var database = firebase.database();
                                            firebase.database().ref("Web_Orders/"+o_l[in1]).child("STATUS").update("CANCELED_BY_CUSTOMER");
